    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <Image
          ...
          alt="Arquero olimpico en posicion de tiro"
          fill
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 text-balance leading-tight">
          Domina el Arte del Tiro con Arco
        </h1>
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
          Aprende la secuencia perfecta para ejecutar un disparo olimpico. 
          Cada paso es fundamental para alcanzar la precision y consistencia 
          que distingue a los arqueros de elite.
        </p>
        <a
          href="#pasos"
